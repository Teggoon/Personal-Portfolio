const ContactPage = () => {
    ...
    <div className="contact-page">
        ...
        <form className="contact-form" action="" method="POST">
            ...
            <input id="contact-form-name-input" className="contact-form-user-input" type="text"></input>
            </div>

            <div className="single-line-input-container">
            <label htmlFor="contact-form-email-input">Email: </label>
            <input id="contact-form-email-input" className="contact-form-user-input" type="email"></input>
            <br/>
            </div>
